...
import CRBActions_US_C_Auth.Step03_Finalize_Auth;
...
public class FinalizeResponse_Auth
{
	// TestNG logger
	...
	public void login() throws InterruptedException
	{
		...
		Step03_Finalize_Auth log = new Step03_Finalize_Auth(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step03_Finalize_Auth respfinal = new Step03_Finalize_Auth(driver);

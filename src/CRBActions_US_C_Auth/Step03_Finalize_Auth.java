...
public class Step03_Finalize_Auth {
...
public Step03_Finalize_Auth(WebDriver driver)
{
	this.driver=driver;
...
public void FinaliseSubmit()
{
	...
	Step03_Finalize_Auth popup = new Step03_Finalize_Auth(driver);

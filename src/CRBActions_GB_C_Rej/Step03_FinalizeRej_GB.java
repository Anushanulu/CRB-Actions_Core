...
public class Step03_FinalizeRej_GB {
...
public Step03_FinalizeRej_GB(WebDriver driver)
{
	this.driver=driver;
...
//	loginToContractor_Link.click();
	...
	Request_Num_Fld.sendKeys(Excel.getCellValue(xlsFilePath, "Request_creation", 5, 15));
	Search_GO_btn.click();
...
public void FinaliseSubmit()
{
	...
	Step03_FinalizeRej_GB popup = new Step03_FinalizeRej_GB(driver);

...
package CRBActions_IN_C_Auth_main;
...
import CRBActions_IN_C_Auth.Step02_ResponeAuth_IN;
...
public class AddResponseRej_IN
{
	// TestNG logger
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step02_ResponeAuth_IN addresp = new Step02_ResponeAuth_IN(driver); 
	    addresp.login();
	}
	@Test(priority=1)
	public void search_request() throws InterruptedException 
	{
		...
		Step02_ResponeAuth_IN search = new Step02_ResponeAuth_IN(driver); 
		search.openRequest();
	...
	@Test(priority=2)
 	public void create_res() throws InterruptedException, IOException 
 	{
		...
		Step02_ResponeAuth_IN btnclick = new Step02_ResponeAuth_IN(driver);
  ...
  @Test(priority=3)
 	public void add_Attachement() 
 	{
	  ...
	  Step02_ResponeAuth_IN attachemnt = new Step02_ResponeAuth_IN(driver); 
	  attachemnt.addAttachement();
 	}
  @Test(priority=4)
	public void fill_resdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponeAuth_IN resdetails = new Step02_ResponeAuth_IN(driver); 
  ...
  @Test(priority=5)
	...
	{
	  Step02_ResponeAuth_IN resattrs = new Step02_ResponeAuth_IN(driver); 
	  resattrs.resAttributeDetails();
	}
  @Test(priority=6)
	public void fill_ratesdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponeAuth_IN rates = new Step02_ResponeAuth_IN(driver); 
	  rates.resRates("20","20");
	}
  @Test(priority=7)
	public void save_Form() throws IOException, InterruptedException  
	{
	  Step02_ResponeAuth_IN save = new Step02_ResponeAuth_IN(driver); 
	  save.saveForm();
	}
}

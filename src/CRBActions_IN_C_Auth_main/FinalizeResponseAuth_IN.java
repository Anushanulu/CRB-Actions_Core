...
import CRBActions_IN_C_Auth.Step03_FinalizeAuth_IN;
...
public class FinalizeResponseAuth_IN
{
	...
	public void login() throws InterruptedException
	{
		...
		Step03_FinalizeAuth_IN log = new Step03_FinalizeAuth_IN(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step03_FinalizeAuth_IN respfinal = new Step03_FinalizeAuth_IN(driver);

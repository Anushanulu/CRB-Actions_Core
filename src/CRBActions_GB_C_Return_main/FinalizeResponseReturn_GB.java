...
import CRBActions_GB_C_Return.Step03_FinalizeReturn_GB;
...
public class FinalizeResponseReturn_GB
{
	// TestNG logger
	...
	public void login() throws InterruptedException
	{
		...
		Step03_FinalizeReturn_GB log = new Step03_FinalizeReturn_GB(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step03_FinalizeReturn_GB respfinal = new Step03_FinalizeReturn_GB(driver);

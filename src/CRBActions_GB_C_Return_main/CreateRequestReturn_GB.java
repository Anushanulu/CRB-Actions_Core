package CRBActions_GB_C_Return_main;
...
import CRBActions_GB_C_Return.Step01_CreateRequestReturn_GB;
...
public class CreateRequestReturn_GB
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException, IOException 
	{
		...
		Step01_CreateRequestReturn_GB login = new Step01_CreateRequestReturn_GB(driver);
		login.login();
	}
	@Test(priority=1)
	public void Create_Req() 
	{
		...
		Step01_CreateRequestReturn_GB createreq = new Step01_CreateRequestReturn_GB(driver);
	...
	public void skill_Req() 
	{
		...
		Step01_CreateRequestReturn_GB skillreq = new Step01_CreateRequestReturn_GB(driver);
	...
	public void select_Req() 
	{
		...
		Step01_CreateRequestReturn_GB selectreq = new Step01_CreateRequestReturn_GB(driver);
	...
	public void req_detail() 
	{
		...
		Step01_CreateRequestReturn_GB reqdetail = new Step01_CreateRequestReturn_GB(driver);
	...
	public void skill_loc() 
	{
		...
		Step01_CreateRequestReturn_GB skillloc = new Step01_CreateRequestReturn_GB(driver);
	...
	public void alert_check() 
	{
		...
		Step01_CreateRequestReturn_GB alertchk = new Step01_CreateRequestReturn_GB(driver);
	...
	public void skill_price() 
	{
		...
		Step01_CreateRequestReturn_GB skillprice = new Step01_CreateRequestReturn_GB(driver);
	...
	public void supp() 
	{
		...
		Step01_CreateRequestReturn_GB supplier = new Step01_CreateRequestReturn_GB(driver);

...
public class Step03_FinalizeAuth_GB {
...
public Step03_FinalizeAuth_GB(WebDriver driver)
{
	this.driver=driver;
...
public void FinaliseSubmit()
{
	...
	Step03_FinalizeAuth_GB popup = new Step03_FinalizeAuth_GB(driver);

...
public class Step03_FinalizeReturn_IN {
...
public Step03_FinalizeReturn_IN(WebDriver driver)
{
	this.driver=driver;
...
//	loginToContractor_Link.click();
	...
	Request_Num_Fld.sendKeys(Excel.getCellValue(xlsFilePath, "Request_creation", 9, 15));
	Search_GO_btn.click();
...
//	Rog.selectByVisibleText(RO);
	...
	Step03_FinalizeReturn_IN popup = new Step03_FinalizeReturn_IN(driver);

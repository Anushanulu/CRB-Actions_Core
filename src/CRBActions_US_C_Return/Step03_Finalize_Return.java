...
public class Step03_Finalize_Return {
...
public Step03_Finalize_Return(WebDriver driver)
{
	this.driver=driver;
...
//	loginToContractor_Link.click();
	...
	Request_Num_Fld.sendKeys(Excel.getCellValue(xlsFilePath, "Request_creation", 6, 15));
	Search_GO_btn.click();
...
public void FinaliseSubmit()
{
	...
	Step03_Finalize_Return popup = new Step03_Finalize_Return(driver);

...
import CRBActions_US_C_Rej.Step01_CreateRequest_Rej;
...
public class CreateRequest_Rej
{
	// TestNG logger
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step01_CreateRequest_Rej login = new Step01_CreateRequest_Rej(driver);
		login.login();
	}
	@Test(priority=1)
	public void Create_Req() 
	{
		...
		Step01_CreateRequest_Rej createreq = new Step01_CreateRequest_Rej(driver);
	...
	public void skill_Req() 
	{
		...
		Step01_CreateRequest_Rej skillreq = new Step01_CreateRequest_Rej(driver);
	...
	public void select_Req() 
	{
		...
		Step01_CreateRequest_Rej selectreq = new Step01_CreateRequest_Rej(driver);
	...
	public void req_detail() 
	{
		...
		Step01_CreateRequest_Rej reqdetail = new Step01_CreateRequest_Rej(driver);
	...
	public void skill_loc() 
	{
		...
		Step01_CreateRequest_Rej skillloc = new Step01_CreateRequest_Rej(driver);
	...
	public void alert_check() 
	{
		...
		Step01_CreateRequest_Rej alertchk = new Step01_CreateRequest_Rej(driver);
	...
	public void skill_price() 
	{
		...
		Step01_CreateRequest_Rej skillprice = new Step01_CreateRequest_Rej(driver);
	...
	public void supp() 
	{
		...
		Step01_CreateRequest_Rej supplier = new Step01_CreateRequest_Rej(driver);

...
import CRBActions_US_C_Rej.Step03_Finalize_Rej;
...
public class FinalizeResponse_Rej
{
	// TestNG logger
	...
	public void login() throws InterruptedException
	{
		...
		Step03_Finalize_Rej log = new Step03_Finalize_Rej(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step03_Finalize_Rej respfinal = new Step03_Finalize_Rej(driver);

...
import CRBActions_US_C_Rej.Step02_ResponseCreation_Rej;
...
public class AddResponse_Rej
{
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step02_ResponseCreation_Rej addresp = new Step02_ResponseCreation_Rej(driver); 
	    addresp.login();
	}
	@Test(priority=1)
	public void search_request() throws InterruptedException 
	{
		...
		Step02_ResponseCreation_Rej search = new Step02_ResponseCreation_Rej(driver); 
		search.openRequest();
	...
	@Test(priority=2)
 	public void create_res() throws InterruptedException, IOException 
 	{
		...
		Step02_ResponseCreation_Rej btnclick = new Step02_ResponseCreation_Rej(driver);
  ...
  @Test(priority=3)
 	public void add_Attachement() 
 	{
	  ...
	  Step02_ResponseCreation_Rej attachemnt = new Step02_ResponseCreation_Rej(driver); 
	  attachemnt.addAttachement();
 	}
  @Test(priority=4)
	public void fill_resdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponseCreation_Rej resdetails = new Step02_ResponseCreation_Rej(driver); 
  ...
  @Test(priority=5)
	...
	{
	  Step02_ResponseCreation_Rej resattrs = new Step02_ResponseCreation_Rej(driver); 
	  resattrs.resAttributeDetails();
	}
  @Test(priority=6)
	public void fill_ratesdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponseCreation_Rej rates = new Step02_ResponseCreation_Rej(driver); 
	  rates.resRates("20","20");
	}
  @Test(priority=7)
	public void save_Form() throws IOException, InterruptedException  
	{
	  Step02_ResponseCreation_Rej save = new Step02_ResponseCreation_Rej(driver); 
	  save.saveForm();
	}
}

...
import CRBActions_IN_C_Return.Step02_ResponeReturn_IN;
...
public class AddResponseReturn_IN
{
	// TestNG logger
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step02_ResponeReturn_IN addresp = new Step02_ResponeReturn_IN(driver); 
	    addresp.login();
	}
	@Test(priority=1)
	public void search_request() throws InterruptedException 
	{
		...
		Step02_ResponeReturn_IN search = new Step02_ResponeReturn_IN(driver); 
		search.openRequest();
	...
	@Test(priority=2)
 	public void create_res() throws InterruptedException, IOException 
 	{
		...
		Step02_ResponeReturn_IN btnclick = new Step02_ResponeReturn_IN(driver);
  ...
  @Test(priority=3)
 	public void add_Attachement() 
 	{
	  ...
	  Step02_ResponeReturn_IN attachemnt = new Step02_ResponeReturn_IN(driver); 
	  attachemnt.addAttachement();
 	}
  @Test(priority=4)
	public void fill_resdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponeReturn_IN resdetails = new Step02_ResponeReturn_IN(driver); 
  ...
  @Test(priority=5)
	...
	{
	  Step02_ResponeReturn_IN resattrs = new Step02_ResponeReturn_IN(driver); 
	  resattrs.resAttributeDetails();
	}
  @Test(priority=6)
	public void fill_ratesdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponeReturn_IN rates = new Step02_ResponeReturn_IN(driver); 
	  rates.resRates("20","20");
	}
  @Test(priority=7)
	public void save_Form() throws IOException, InterruptedException  
	{
	  Step02_ResponeReturn_IN save = new Step02_ResponeReturn_IN(driver); 
	  save.saveForm();
	}
}

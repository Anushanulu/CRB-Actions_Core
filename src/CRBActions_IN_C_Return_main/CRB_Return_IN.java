...
import CRBActions_IN_C_Return.Step04_CRB_Return_IN;
...
//		driver = new ChromeDriver();
	...
	public void CRB_Switch() throws InterruptedException 
	{
		...
		Step04_CRB_Return_IN switching = new Step04_CRB_Return_IN(driver);
	...
	public void CRB_auth() 
	{
		...
		Step04_CRB_Return_IN auth = new Step04_CRB_Return_IN(driver);
		auth.crb_auth();
	}

...
public class Step03_FinalizeAuth_IN {
...
public Step03_FinalizeAuth_IN(WebDriver driver)
{
	this.driver=driver;
...
//	Rog.selectByVisibleText(RO);
	...
	Step03_FinalizeAuth_IN popup = new Step03_FinalizeAuth_IN(driver);

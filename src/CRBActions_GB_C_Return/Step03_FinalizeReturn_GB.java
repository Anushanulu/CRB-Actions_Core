...
public class Step03_FinalizeReturn_GB {
...
public Step03_FinalizeReturn_GB(WebDriver driver)
{
	this.driver=driver;
...
public void FinaliseSubmit()
{
	...
	Step03_FinalizeReturn_GB popup = new Step03_FinalizeReturn_GB(driver);

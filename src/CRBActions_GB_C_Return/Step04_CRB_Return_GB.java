package CRBActions_GB_C_Return;
...
@FindBy (name="btnRejectCandidate") private WebElement Reject ;
...
@FindBy ( name="btnReturnAsFinalistCandidate") private WebElement Return_Button ;
@FindBy ( name="txtSaveAndReturnAsFinalist") private WebElement saveAndReturn ;
...
public void CRB_Auth()
{
	...
	Req_Num_Search.sendKeys(Excel.getCellValue(xlsFilePath, "Request_creation", 8, 15));
	GO_reqnum.click();

	String Req_Num = Excel.getCellValue(xlsFilePath, "Request_creation", 8, 15) ;
	...
	wait06.until(ExpectedConditions.visibilityOf(Return_Button));

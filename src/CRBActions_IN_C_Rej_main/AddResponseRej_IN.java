...
package CRBActions_IN_C_Rej_main;
...
import CRBActions_IN_C_Rej.Step02_ResponeRej_IN;
...
public class AddResponseRej_IN
{
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step02_ResponeRej_IN addresp = new Step02_ResponeRej_IN(driver); 
	    addresp.login();
	}
	@Test(priority=1)
	public void search_request() throws InterruptedException 
	{
		...
		Step02_ResponeRej_IN search = new Step02_ResponeRej_IN(driver); 
		search.openRequest();
	...
	@Test(priority=2)
 	public void create_res() throws InterruptedException, IOException 
 	{
		...
		Step02_ResponeRej_IN btnclick = new Step02_ResponeRej_IN(driver);
  ...
  @Test(priority=3)
 	public void add_Attachement() 
 	{
	  ...
	  Step02_ResponeRej_IN attachemnt = new Step02_ResponeRej_IN(driver); 
	  attachemnt.addAttachement();
 	}
  @Test(priority=4)
	public void fill_resdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponeRej_IN resdetails = new Step02_ResponeRej_IN(driver); 

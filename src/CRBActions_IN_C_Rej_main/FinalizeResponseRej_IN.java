...
import CRBActions_IN_C_Rej.Step03_FinalizeRej_IN;
...
public class FinalizeResponseRej_IN
{
	// TestNG logger
	...
	public void login() throws InterruptedException
	{
		...
		Step03_FinalizeRej_IN log = new Step03_FinalizeRej_IN(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step03_FinalizeRej_IN respfinal = new Step03_FinalizeRej_IN(driver);

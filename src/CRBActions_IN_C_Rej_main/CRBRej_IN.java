...
import CRBActions_IN_C_Rej.Step04_CRB_Rej_IN;
...
//		driver = new ChromeDriver();
	...
	public void CRB_Wlcmpage() throws InterruptedException 
	{
		...
		Step04_CRB_Rej_IN crblogin = new Step04_CRB_Rej_IN(driver);
		crblogin.login();
	}
	@Test(priority=1)
	public void CRB_Switch() throws InterruptedException 
	{

		Step04_CRB_Rej_IN switching = new Step04_CRB_Rej_IN(driver);
	...
	public void CRB_auth() 
	{
		...
		Step04_CRB_Rej_IN auth = new Step04_CRB_Rej_IN(driver);
		auth.crb_auth();
	}

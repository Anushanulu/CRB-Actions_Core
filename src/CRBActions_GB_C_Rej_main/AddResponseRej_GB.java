...
package CRBActions_GB_C_Rej_main;
...
import CRBActions_GB_C_Rej.Step02_ResponeRej_GB;
...
public class AddResponseRej_GB
{
	// TestNG logger
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step02_ResponeRej_GB addresp = new Step02_ResponeRej_GB(driver); 
	    addresp.login();
	}
	@Test(priority=1)
	public void search_request() throws InterruptedException 
	{
		...
		Step02_ResponeRej_GB search = new Step02_ResponeRej_GB(driver); 
		search.openRequest();
	...
	@Test(priority=2)
 	public void create_res() throws InterruptedException, IOException 
 	{
		...
		Step02_ResponeRej_GB btnclick = new Step02_ResponeRej_GB(driver);
  ...
  @Test(priority=3)
 	public void add_Attachement() 
 	{
	  ...
	  Step02_ResponeRej_GB attachemnt = new Step02_ResponeRej_GB(driver); 
	  attachemnt.addAttachement();
 	}
  @Test(priority=4)
	public void fill_resdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponeRej_GB resdetails = new Step02_ResponeRej_GB(driver); 

...
import CRBActions_GB_C_Rej.Step03_FinalizeRej_GB;
...
public class FinalizeResponseRej_GB
{
	// TestNG logger
	...
	public void login() throws InterruptedException
	{
		...
		Step03_FinalizeRej_GB log = new Step03_FinalizeRej_GB(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step03_FinalizeRej_GB respfinal = new Step03_FinalizeRej_GB(driver);

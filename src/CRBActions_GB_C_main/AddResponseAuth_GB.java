...
import CRBActions_GB_C.Step02_ResponeAuth_GB;
...
public class AddResponseAuth_GB
{
	// TestNG logger
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step02_ResponeAuth_GB addresp = new Step02_ResponeAuth_GB(driver); 
	    addresp.login();
	}
	@Test(priority=1)
	public void search_request() throws InterruptedException 
	{
		...
		Step02_ResponeAuth_GB search = new Step02_ResponeAuth_GB(driver); 
		search.openRequest();
	...
	@Test(priority=2)
 	public void create_res() throws InterruptedException, IOException 
 	{
		...
		Step02_ResponeAuth_GB btnclick = new Step02_ResponeAuth_GB(driver);
  ...
  @Test(priority=3)
 	public void add_Attachement() 
 	{
	  ...
	  Step02_ResponeAuth_GB attachemnt = new Step02_ResponeAuth_GB(driver); 
	  attachemnt.addAttachement();
 	}
  @Test(priority=4)
	public void fill_resdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponeAuth_GB resdetails = new Step02_ResponeAuth_GB(driver); 
  ...
  @Test(priority=5)
	...
	{
	  Step02_ResponeAuth_GB resattrs = new Step02_ResponeAuth_GB(driver); 
	  resattrs.resAttributeDetails();
	}
  @Test(priority=6)
	public void fill_ratesdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponeAuth_GB rates = new Step02_ResponeAuth_GB(driver); 
	  rates.resRates("20","20");
	}
  @Test(priority=7)
	public void save_Form() throws IOException, InterruptedException  
	{
	  Step02_ResponeAuth_GB save = new Step02_ResponeAuth_GB(driver); 
	  save.saveForm();
	}
}

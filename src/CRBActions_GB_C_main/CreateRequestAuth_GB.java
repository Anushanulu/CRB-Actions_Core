...
import CRBActions_GB_C.Step01_CreateRequestAuth_GB;
...
public class CreateRequestAuth_GB
{
	// TestNG logger
...
//		driver = new ChromeDriver();
	...
	public void RIPC_Login() throws InterruptedException, IOException 
	{
		...
		Step01_CreateRequestAuth_GB login = new Step01_CreateRequestAuth_GB(driver);
		login.login();
	}
	@Test(priority=1)
	public void Create_Req() 
	{
		...
		Step01_CreateRequestAuth_GB createreq = new Step01_CreateRequestAuth_GB(driver);
	...
	public void skill_Req() 
	{
		...
		Step01_CreateRequestAuth_GB skillreq = new Step01_CreateRequestAuth_GB(driver);
	...
	public void select_Req() 
	{
		...
		Step01_CreateRequestAuth_GB selectreq = new Step01_CreateRequestAuth_GB(driver);
	...
	public void req_detail() 
	{
		...
		Step01_CreateRequestAuth_GB reqdetail = new Step01_CreateRequestAuth_GB(driver);
	...
	public void skill_loc() 
	{
		...
		Step01_CreateRequestAuth_GB skillloc = new Step01_CreateRequestAuth_GB(driver);
	...
	public void alert_check() 
	{
		...
		Step01_CreateRequestAuth_GB alertchk = new Step01_CreateRequestAuth_GB(driver);
	...
	public void skill_price() 
	{
		...
		Step01_CreateRequestAuth_GB skillprice = new Step01_CreateRequestAuth_GB(driver);
	...
	public void supp() 
	{
		...
		Step01_CreateRequestAuth_GB supplier = new Step01_CreateRequestAuth_GB(driver);

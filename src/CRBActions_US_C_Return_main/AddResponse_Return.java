...
import CRBActions_US_C_Return.Step02_ResponseCreation_Return;
...
public class AddResponse_Return
{
	// TestNG logger
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step02_ResponseCreation_Return addresp = new Step02_ResponseCreation_Return(driver); 
	    addresp.login();
	}
	@Test(priority=1)
	public void search_request() throws InterruptedException 
	{
		...
		Step02_ResponseCreation_Return search = new Step02_ResponseCreation_Return(driver); 
		search.openRequest();
	...
	@Test(priority=2)
 	public void create_res() throws InterruptedException, IOException 
 	{
		...
		Step02_ResponseCreation_Return btnclick = new Step02_ResponseCreation_Return(driver);
  ...
  @Test(priority=3)
 	public void add_Attachement() 
 	{
	  ...
	  Step02_ResponseCreation_Return attachemnt = new Step02_ResponseCreation_Return(driver); 
	  attachemnt.addAttachement();
 	}
  @Test(priority=4)
	public void fill_resdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponseCreation_Return resdetails = new Step02_ResponseCreation_Return(driver); 
  ...
  @Test(priority=5)
	...
	{
	  Step02_ResponseCreation_Return resattrs = new Step02_ResponseCreation_Return(driver); 
	  resattrs.resAttributeDetails();
	}
  @Test(priority=6)
	public void fill_ratesdetails() throws IOException, InterruptedException  
	{
	  Step02_ResponseCreation_Return rates = new Step02_ResponseCreation_Return(driver); 
	  rates.resRates("20","20");
	}
  @Test(priority=7)
	public void save_Form() throws IOException, InterruptedException  
	{
	  Step02_ResponseCreation_Return save = new Step02_ResponseCreation_Return(driver); 
	  save.saveForm();
	}
}

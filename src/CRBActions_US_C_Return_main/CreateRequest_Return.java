package CRBActions_US_C_Return_main;
...
import CRBActions_US_C_Return.Step01_CreateRequest_Return;
...
public class CreateRequest_Return
{
	// TestNG logger
	...
	public void RIPC_Login() throws IOException, InterruptedException 
	{
		...
		Step01_CreateRequest_Return login = new Step01_CreateRequest_Return(driver);
		login.login();
	}
	@Test(priority=1)
	public void Create_Req() 
	{
		...
		Step01_CreateRequest_Return createreq = new Step01_CreateRequest_Return(driver);
	...
	public void skill_Req() 
	{
		...
		Step01_CreateRequest_Return skillreq = new Step01_CreateRequest_Return(driver);
	...
	public void select_Req() 
	{
		...
		Step01_CreateRequest_Return selectreq = new Step01_CreateRequest_Return(driver);
	...
	public void req_detail() 
	{
		...
		Step01_CreateRequest_Return reqdetail = new Step01_CreateRequest_Return(driver);
	...
	public void skill_loc() 
	{
		...
		Step01_CreateRequest_Return skillloc = new Step01_CreateRequest_Return(driver);
	...
	public void alert_check() 
	{
		...
		Step01_CreateRequest_Return alertchk = new Step01_CreateRequest_Return(driver);
	...
	public void skill_price() 
	{
		...
		Step01_CreateRequest_Return skillprice = new Step01_CreateRequest_Return(driver);
	...
	public void supp() 
	{
		...
		Step01_CreateRequest_Return supplier = new Step01_CreateRequest_Return(driver);

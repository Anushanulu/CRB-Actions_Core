...
import CRBActions_US_C_Return.Step03_Finalize_Return;
...
public class FinalizeResponse_Return
{
	// TestNG logger
	...
	public void login() throws InterruptedException
	{
		...
		Step03_Finalize_Return log = new Step03_Finalize_Return(driver);
		log.loginAndOpenReq();
	...
	public void Finalize()
	{
		...
		Step03_Finalize_Return respfinal = new Step03_Finalize_Return(driver);
